...
def tensor2im(input_image, img_name, norm=1, imtype=np.uint8):
    lq_path = '/home/omnisky/storage/face/yyj/dataset/real_zpy_512/'+img_name
    hq_path = '/home/omnisky/storage/face/yyj/dataset/real_zpy_512/'+img_name
    ...
    output = np.concatenate((lq_np, image_numpy,  hq_np), axis=1)
    #print(output.shape)
