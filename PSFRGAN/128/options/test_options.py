...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--src_dir', type=str, default='', help='../../../dataset/celeba/celeba_full128/')
        ...
        #parser.add_argument('--psfr_net_weight', type=str, default='../../../latest_net_G.pth', help='parse model path')

        parser.add_argument('--psfr_net_weight', type=str, default='./check_points/X2_X4_X8_full_new/iter_500000_net_G.pth', help='parse model path')
