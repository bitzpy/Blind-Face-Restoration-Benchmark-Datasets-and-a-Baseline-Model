...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--visual_freq', type=int, default=5000, help='frequency of show training images in tensorboard')
        parser.add_argument('--print_freq', type=int, default=1000, help='frequency of showing training results on console')
        # network saving and loading parameters
        parser.add_argument('--save_iter_freq', type=int, default=100000, help='frequency of saving the models')
        ...
        parser.add_argument('--total_epochs', type=int, default=3, help='# of epochs to train')
