...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--visual_freq', type=int, default=3000, help='frequency of show training images in tensorboard')
        parser.add_argument('--print_freq', type=int, default=1000, help='frequency of showing training results on console')
        # network saving and loading parameters
        parser.add_argument('--save_iter_freq', type=int, default=30000, help='frequency of saving the models')
        parser.add_argument('--save_latest_freq', type=int, default=10000, help='save latest freq')
        ...
        parser.add_argument('--total_epochs', type=int, default=2, help='# of epochs to train')
        ...
        parser.add_argument('--d_lr', type=float, default=0.004, help='discriminator learning rate')
